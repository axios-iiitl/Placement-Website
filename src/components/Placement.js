  ...
  return (
    <div className="stats">
      ...
      <p>
        ...
        <br />
        <br />
        We highly value our partnership with recruiters & remain committed to
        ...
        <br />
        <br />
        Here are some Statistics regarding the placement of the batch graduating
        in 2019:
        <br />
        <br />
        </p>
        <ul style={{marginLeft: "2vw"}}>
          <li>Highest Package: 27 lpa</li>
          <li>Lowest Package: 4.50 lpa</li>
          <li>Percentage of students placed: 67.50%</li>
          <li>Average of top 50%: 12.83 lpa</li>
          <li>Average of top 20%: 20.50 lpa</li>
          <li>Average of total students: 11.08 lpa</li>
          <li>Number of students registered: 40</li>
        </ul>
    </div>
  );
};
